...
//console.log("toggleChalkboardButton")
		...
		button.innerHTML = '<a href="#" id="square" title="Toggle chalkboard ('+keyBindings.toggleChalkboard.key+')" onclick="RevealChalkboard.toggleChalkboard(); return false;"><i class="fa fa-pen-square"></i></a>'
...
//console.log("toggleNotesButton")
		...
		button.innerHTML = '<a href="#" id="pen" title="Toggle slide annotation ('+keyBindings.toggleNotesCanvas.key+')" onclick="RevealChalkboard.toggleNotesCanvas(); return false;"><i class="fa fa-pen"></i></a>'
		document.querySelector(".reveal").appendChild( button );
	}
//alert("Buttons");
